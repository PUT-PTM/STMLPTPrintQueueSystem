...
void pinMode(int pin, char in_output[6]){
	if(in_output == 'input'){
	//set pin to read data
	
	}else if(in_output == 'output'){
	//set pin to write data
		
	}else{
		//error
	}
}
void digitalWrite(int pin,bit state ){
	//set pint to HIGH or LOW state;
...
//rozbijamy 8bitowy rozkz na poszczegolne bity
...
//ustawiamy stany 0/1 na naszych pinach
